var projects = {
  "flutter": {
    "name": "Flutter",
    "q": "org:flutter is:issue is:open label:\"easy fix\""
  },
  "node": {
    "name": "Node.js",
  ...
  "strapi": {
    "name": "Strapi",
    "q":
        "repo:strapi/strapi is:issue is:open label:\"Good for new contributors\""
  },
  "create-react-app": {
  ...
  "bigtestjs.io": {
    "name": "BigTestjs.io",
    "q":
        "repo:bigtestjs/bigtestjs.io is:open is:issue label:\"good first issue\""
  },
  "feeling-lucky": {
  ...
  "netlify": {
    "name": "Netlify",
    "q":
        "org:netlify is:issue is:open sort:updated-desc label:\"good first issue\""
  },
  "gatsby": {
    "name": "Gatsby",
  ...
  "react-native": {
    "name": "React Native",
    "q":
        "repo:facebook/react-native is:issue is:open label:\"Good first issue\""
  },
  "babel": {
    "name": "Babel",
    "q":
